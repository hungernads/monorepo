...
export const EXPLORER_TX_URL = `${monadChain.blockExplorers?.default.url ?? 'https://monadexplorer.com'}/tx/`;

/** Block explorer base URL for address links. */
export const EXPLORER_ADDRESS_URL = `${monadChain.blockExplorers?.default.url ?? 'https://monadexplorer.com'}/address/`;
